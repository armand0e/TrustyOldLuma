...
"""
PyInstaller spec file for TrustyOldLuma Setup - Development Build
Creates a directory-based distribution for faster development builds.
"""
...
# Executable configuration for development (directory-based)
exe = EXE(
    pyz,
    a.scripts,
    [],
    exclude_binaries=True,
    name='TrustyOldLuma-Setup-Dev',
    debug=True,
